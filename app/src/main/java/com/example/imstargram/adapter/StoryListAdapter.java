...
import com.example.imstargram.CommentsActivity;
import com.example.imstargram.R;
import com.example.imstargram.helper.SquareImageView;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(story != null){
            ...
            if(story.getProfile_image().isEmpty()){
                ...
                Picasso.get().load(story.getProfile_image()).error(R.drawable.ic_user).into(profile_photo);
            }
            if(story.getStory_image().isEmpty()) {
                profile_photo.setImageResource(R.drawable.ic_user);
            }else{
                Picasso.get().load(story.getStory_image()).error(R.drawable.ic_user).into(story_image);
            }
